...
//	    getEfficiency_SYSDPT((float) bin.pl,(float) bin.ph, -2.4, 2.4, bin.cl, bin.ch, true, true, false, kTrigUps, true, bin.state, 1);
...
//	    getEfficiency_SYSDPTDOWN((float) bin.pl,(float) bin.ph, -2.4, 2.4, bin.cl, bin.ch, true, true, false, kTrigUps, true, bin.state, 1);
	    getEfficiencyBDT_SYSDPT((float) bin.pl,(float) bin.ph, -2.4, 2.4, bin.cl, bin.ch, true, true, 9999999999, bl, 1, bin.state, bin.state, 0);
