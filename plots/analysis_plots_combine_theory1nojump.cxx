void analysis_plots_combine_func_theory1nojump(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//////////////////////////////Auxiliary Drawings///////////////////////////////
	...
	TLegend* leg_cent_theory = new TLegend(0.60, 0.45, 0.85, 0.69);
	...
	leg_cent_addtxt->SetTextSize(0.032);

	TLegend* leg_pt_theory = new TLegend(0.54, 0.45, 0.85, 0.69);
	...
	leg_pt_addtxt->SetTextSize(0.030);
//////////////////////////////////INITIALIZE CANVASES/////////////////////////////////
...
//    draw_theory_EPPS16(p1_L, leg_cent, kTCent, 3);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 2);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 3);
...
//    draw_theory_EPPS16(p2,leg_pt,  kTPt, 3);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 2);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 3);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_theory1_new.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_theory1_new.pdf", _TS) );
...
//	towrite["xcx"] = xcx;
	...
	leg_cent_theory->SetHeader("#lower[-0.1]{#scale[1.2]{#bf{OQS + pNRQCD}}}");
	...
	leg_pt_theory->SetTextFont(42);
	leg_pt_theory->SetTextSize(0.030);
	leg_pt_theory->SetHeader("#lower[-0.1]{#scale[1.2]{#bf{OQS + pNRQCD}}}");
...
//	g_c23s->Draw("PE");
	g_c23s_sys->Draw("5");
    draw_theory_QTraj2023(p1_L, leg_cent_theory, kTCent, 32, false);
    draw_theory_QTraj2023(p1_L, leg_cent_theory, kTCent, 32, true);
...
//    draw_theory_EPPS16(p1_L, leg_cent,  kTCent, 4);
	...
	leg_cent->Draw("same");
	leg_cent_theory->Draw();
//	leg_cent_addtxt->DrawLatex(234, 1.063, "(without jump)");
	b_3serr->Draw("L");
...
//	g_p23s->Draw("PE");
	g_p23s_sys->Draw("5");
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 32, false);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 32, true);
...
//	tl->DrawLatex( 2.5, label_pos_up + 0.05,"p_{T} < 30 GeV/c");
	...
	leg_pt->Draw("same");
	leg_pt_theory->Draw();
//	leg_pt_addtxt->DrawLatex(15.7, 1.063, "(without jump)");
	...
	c1->SaveAs(Form("../checkout/tscol/DR_centrality_int_%ld_v3_theory1_wojump.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/DR_pt_%ld_v3_theory1_wojump.pdf", _TS) );
