void analysis_plots_combine_func_theory3_2(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_theory3_2.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_theory3_2.pdf", _TS) );
...
//	towrite["xcx"] = xcx;
    ...
    b_3serr->SetFillColorAlpha(12, 0.0);
    b_3serr->SetLineWidth(2);
	b_3serr->SetLineColor(kGray+2);

	p1_L->SetLeftMargin(0.12);
	p2->SetLeftMargin(0.12);

	leg_cent = new TLegend(0.36,0.63, 0.92, 0.70);
	leg_cent->AddEntry(g_c23s, "Data", "pl");
	leg_cent->SetNColumns(2);
	leg_cent->SetBorderSize(0);
	leg_cent->SetTextFont(42);
	leg_cent->SetTextSize(0.030);

	leg_pt = new TLegend(0.27,0.63, 0.86, 0.72);
	leg_pt->AddEntry(g_p23s, "Data", "pl");
	leg_pt->SetNColumns(2);
	leg_pt->SetBorderSize(0);
	leg_pt->SetTextFont(42);
	leg_pt->SetTextSize(0.030);
...
//    draw_theory_QTraj(p1_L, leg_cent, kTCent, 32);
    draw_theory_Transport(p1_L, leg_cent,  kTCent, 32);
...
//	g_p23s->Draw("PE");
	g_p23s_sys->Draw("5");
    draw_theory_Transport(p2, leg_pt, kTPt, 32);
...
//	tl->DrawLatex( 2.5, label_pos_up + 0.05,"#it{p}_{T} < 30 GeV/c");
	...
	c1->SaveAs(Form("../checkout/tscol/DR_centrality_int_%ld_v3_theory3_2.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/DR_pt_%ld_v3_theory3_2.pdf", _TS) );
