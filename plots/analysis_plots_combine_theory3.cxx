void analysis_plots_combine_func_theory3(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//////////////////////////////Auxiliary Drawings///////////////////////////////
	...
	TLegend* leg_cent = new TLegend(0.40, 0.442, 0.65, 0.60);
	...
	TLegend* leg_cent_theory = new TLegend(0.68, 0.45, 0.88, 0.67);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_theory3.pdf", _TS) );
//	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_theory3.pdf", _TS) );
...
//	g_c23s->Draw("PE");
	g_c23s_sys->Draw("5");
    draw_theory_CIMnCTEQ15(p1_L, leg_cent, kTCent, 32);
//    draw_theory_EPPS16(p1_L, leg_cent,  kTCent, 4);
	...
	g_p23s->Draw("APE");
	g_p23s_sys->Draw("5");
//    draw_theory_CIMnCTEQ15(p2, leg_pt, kTPt, 32); NO!
...
//	tl->DrawLatex( 2.5, label_pos_up + 0.02,"#it{p}_{T} < 30 GeV/c");
	...
	c1->SaveAs(Form("../checkout/tscol/DR_centrality_int_%ld_v3_theory3.pdf", _TS) );
//	c2->SaveAs(Form("../checkout/tscol/DR_pt_%ld_v3_theory3.pdf", _TS) );
