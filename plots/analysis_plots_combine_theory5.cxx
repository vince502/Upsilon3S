void analysis_plots_combine_func_theory5(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_theory5.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_theory5.pdf", _TS) );
...
//	towrite["xcx"] = xcx;
	...
	leg_cent = new TLegend(0.26,0.63, 0.98, 0.73);
	leg_cent->SetNColumns(3);
	...
	leg_pt = new TLegend(0.17,0.63, 0.86, 0.70);
	...
	p1_L->cd();
	g_c23s->Draw("APE");
    draw_theory_QTraj(p1_L, leg_cent, kTCent, 32, false);
    draw_theory_CIMnCTEQ15(p1_L, leg_cent, kTCent, 32, false);
    draw_theory_EPPS16(p1_L, leg_cent,  kTCent, 4, true);
    draw_theory_Transport(p1_L, leg_cent, kTCent, 32, false);
	g_c23s->Draw("PE");
	g_c23s_sys->Draw("5");
...
//	tl->DrawLatex( 2.5, label_pos_up + 0.02,"#it{p}_{T} < 30 GeV/c");
	...
	c1->SaveAs(Form("../checkout/tscol/DR_centrality_int_%ld_v3_theory5.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/DR_pt_%ld_v3_theory5.pdf", _TS) );
