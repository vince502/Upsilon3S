...
void analysis_plots_combine_func_w1s_theory2reg(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//    draw_theory_EPPS16(p1_L, leg_cent, kTCent, 3);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 1);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 1, false);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 2);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 2, false);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 3);
    draw_theory_QTraj2023(p1_L,  leg_cent_theory, kTCent, 3, false);
	...
	p1L_legT->DrawLatex(242, 0.74, "Total  #kern[-0.18]{#lower[-1.1]{#scale[1.2]{#bf{OQS+pNRQCD}}}}   #kern[-0.85]{No recomb.}");
	b_err->  Draw("L");
	b_2serr->Draw("L");
	b_3serr->Draw("L");
...
//    draw_theory_EPPS16(p2,leg_pt,  kTPt, 3);
    ...
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 1);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 1, false);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 2);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 2, false);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 3);
    draw_theory_QTraj2023(p2, leg_pt_theory, kTPt, 3, false);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_w1s_theory2_new.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_w1s_theory2_new.pdf", _TS) );
...
//	leg_pt_theory->AddEntry((TObject*) 0, "No recomb.","");
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 1, true);
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 1, false);
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 2, true);
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 2, false);
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 3, true);
    draw_theory_QTraj2023(p3, leg_pt_theory, kTPt, 3, false);
...
//	p2_latex1 = tl->DrawLatex( 2.5, 1.15,"p_{T} < 30 GeV/c");
	...
	p2_legT->DrawLatex(leg_pt_theory->GetX1()+1.6, 5, "Total  #kern[-0.18]{#lower[-1.1]{#scale[1.2]{#bf{OQS+pNRQCD}}}}   #kern[-0.77]{No recomb.}");
	leg_pt_box->Draw();
	leg_pt->Draw();
	leg_pt_theory->Draw();
	b_pterr->Draw("L");
	...
	c2->Update();
	c2->Modified();
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_w1s_theory2_new_logy.pdf", _TS) );
//	for(auto item : towrite){
//		item.second->Write();
//	}
	output->cd();
