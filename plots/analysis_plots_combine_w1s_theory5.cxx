...
void analysis_plots_combine_func_w1s_theory5(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//    draw_theory_EPPS16(p1_L, leg_cent, kTCent, 3);
    draw_theory_Heidelberg(p1_L,  leg_cent_theory, kTCent, 1);
    draw_theory_Heidelberg(p1_L,  leg_cent_theory, kTCent, 2);
    draw_theory_Heidelberg(p1_L,  leg_cent_theory, kTCent, 3);
...
//    draw_theory_EPPS16(p2,leg_pt,  kTPt, 3);
    draw_theory_Heidelberg(p2, leg_pt_theory, kTPt, 1);
    draw_theory_Heidelberg(p2, leg_pt_theory, kTPt, 2);
    draw_theory_Heidelberg(p2, leg_pt_theory, kTPt, 3);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_w1s_theory5.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_w1s_theory5.pdf", _TS) );
