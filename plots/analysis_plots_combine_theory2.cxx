void analysis_plots_combine_func_theory2(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//	g_c2s->Draw("PE");
	...
	g_c2s_sys->Draw("5");
	g_c3s_sys->Draw("5");
    draw_theory_EPPS16(p1_L, leg_cent_theory, kTCent, 2);
    draw_theory_EPPS16(p1_L, leg_cent_theory, kTCent, 3);
...
//	g_p2s->Draw("PE");
	...
	g_p2s_sys->Draw("5");
	g_p3s_sys->Draw("5");
    draw_theory_EPPS16(p2,leg_pt_theory,  kTPt, 2);
    draw_theory_EPPS16(p2,leg_pt_theory,  kTPt, 3);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_theory2.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_theory2.pdf", _TS) );
...
//	tl->DrawLatex( 2.5, label_pos_up + 0.05,"p_{T} < 30 GeV/c");
	...
	c1->SaveAs(Form("../checkout/tscol/DR_centrality_int_%ld_v3_theory2.pdf", _TS) );
	c2->SaveAs(Form("../checkout/tscol/DR_pt_%ld_v3_theory2.pdf", _TS) );
