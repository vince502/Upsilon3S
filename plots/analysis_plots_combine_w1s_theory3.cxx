...
void analysis_plots_combine_func_w1s_theory3(TFile* hf, TFile* hsys, TFile* ppsys, TFile* hdff, TFile* hdfsys, TFile* ppdfsys)
{
...
//    draw_theory_QTraj(p1_L,  leg_cent_theory, kTCent, 3);
    draw_theory_CIMnCTEQ15(p1_L,  leg_cent_theory, kTCent, 1);
...
//	towrite["p2_latex1"] = p2_latex1;
	...
	c1->SaveAs(Form("../checkout/tscol/RAA_centrality_int_%ld_v3_w1s_theory3.pdf", _TS) );
//	c2->SaveAs(Form("../checkout/tscol/RAA_pt_%ld_v3_w1s_theory3.pdf", _TS) );
