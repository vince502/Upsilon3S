...
\begin{table}[htb]
	\begin{center}
	\cation{Result 2S, Centrality [0, 181], $p_{T}$ [0, 4]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 2S, Centrality [0, 181], $p_{T}$ [4, 9]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 2S, Centrality [0, 181], $p_{T}$ [9, 30]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 3S, Centrality [40, 100], $p_{T}$ [0, 30]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 3S, Centrality [100, 181], $p_{T}$ [0, 30]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 3S, Centrality [0, 181], $p_{T}$ [0, 6]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
...
\begin{table}[htb]
	\begin{center}
	\cation{Result 3S, Centrality [0, 181], $p_{T}$ [6, 30]
}
{\footnotesize\renewcommand{\arraystretch}{1.4}
		\begin{tabular}{cc||cccc}
			N & NLL & p(H0: N = 1) & p(H0: N = 2) & p(H0: N = 3) & p(H0: N = 4)\\ 
