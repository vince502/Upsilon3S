...
void MassYield1SMCFit(const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const TString MupT = "4", int Trig = 1, int cBinHigh = 180){
  int cBinLow = 0;
