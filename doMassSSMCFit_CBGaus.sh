...
root -l -b -q 'MassYieldFit_CBGaus_MC.C("OniaRooDataSet_OniaSkim_TrigS13_MC.root", "OniaRooDataSet_UpsTrig_isMC1_HFNom_201222.root", 0, 50, -2.4, 2.4, "4", "Ups", 180, 1, true)'
