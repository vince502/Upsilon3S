...
void MC_MassYieldFit(const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const TString MupT = "4", int Trig = 1, int cBinHigh = 180){
  int cBinLow = 0;
  ...
  TFile* fout;
  fout = new TFile(Form("Yield/MC_Yield_pt_%d-%d_rap_%d-%d_Data_noWeight_MupT%s.root", (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), MupT.Data()), "RECREATE");
  ...
  ifstream in;
  in.open(Form("Parameter/MC_Parameters_pt_%d-%d_rap_%d-%d_Data_Trig_%d_noWeight_MupT%s.txt", (int)(ptMin*10), (int)(ptMax*10), (int)(rapMin*10), (int)(rapMax*10), Trig,  MupT.Data()));
  if(in.is_open())
  {
     while(!in.eof())
     {
...
//  RooRealVar* nSig2S = new RooRealVar("nSig2S", "# of 2S signal", 100, -1000, 300000);
  ...
  c1->SaveAs(Form("MassDist/MassDistribution_pt_%d-%d_rap_%d-%d_%dbin_noWeight_MupT%s_Trig_%d_MC.pdf",(int)(ptMin*10), (int)(ptMax*10), (int)(rapMin*10), (int)(rapMax*10), Nmassbins, MupT.Data(), Trig));
  ...
  c2->SaveAs(Form("MassDist/WithoutFit_pt_%d-%d_rap_%d-%d_%dbin_noWeight_MupT%s_Trig_%d_MC.pdf",(int)(ptMin*10), (int)(ptMax*10), (int)(rapMin*10), (int)(rapMax*10),  Nmassbins, MupT.Data(), Trig));
