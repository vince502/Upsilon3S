...
root -l -b -q 'MassYieldFit_fix.C("OniaRooDataSet_OniaSkim_TrigS13.root", 0, 30, -2.4, 2.4, "3p5", "S13", 0, 180, (Double_t[]) {0.05, 2.0, 2.0, 0.5, 5, 1, 1})' &  2>/dev/null
root -l -b -q 'MassYieldFit_fix.C("OniaRooDataSet_OniaSkim_TrigS13.root", 0, 4, -2.4, 2.4, "3p5", "S13", 0, 180, (Double_t[]) {0.05, 2.0, 2.0, 0.5, 5, 1, 1})' &  2>/dev/null
root -l -b -q 'MassYieldFit_fix.C("OniaRooDataSet_OniaSkim_TrigS13.root", 4, 9, -2.4, 2.4, "3p5", "S13", 0, 180, (Double_t[]) {0.05, 2.0, 2.0, 0.5, 5, 1, 1})' &  2>/dev/null
root -l -b -q 'MassYieldFit_fix.C("OniaRooDataSet_OniaSkim_TrigS13.root", 9, 12, -2.4, 2.4, "3p5", "S13", 0, 180, (Double_t[]) {0.05, 2.0, 2.0, 0.5, 5, 1, 1})' &  2>/dev/null
root -l -b -q 'MassYieldFit_fix.C("OniaRooDataSet_OniaSkim_TrigS13.root", 12, 30, -2.4, 2.4, "3p5", "S13", 0, 180, (Double_t[]) {0.05, 2.0, 2.0, 0.5, 5, 1, 1})' &  2>/dev/null
