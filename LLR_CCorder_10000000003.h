...
#include <map>
#define GETBKGO
int getNomBkgO_10000000003(int state, int pl, int ph, int cl, int ch)
{
	...
	if( (state == 2 && pl == 0 && ph == 30 && cl == 60 && ch == 80) ) return 4;
	...
	if( (state == 3 && pl == 0 && ph == 30 && cl == 0 && ch == 40) ) return 3;
	if( (state == 3 && pl == 0 && ph == 30 && cl == 40 && ch == 80) ) return 4;
	if( (state == 3 && pl == 0 && ph == 30 && cl == 80 && ch == 100) ) return 1;
	if( (state == 3 && pl == 0 && ph == 30 && cl == 100 && ch == 140) ) return 1;
	...
	if( (state == 3 && pl == 9 && ph == 15 && cl == 0 && ch == 181) ) return 3;
...
#ifdef GETBKGO
#define GETBKGO2
int getNomBkgO_10000000003(ana_bins x){
	return getNomBkgO_10000000003(x.state, x.pl, x.ph, x.cl, x.ch);
};
#endif