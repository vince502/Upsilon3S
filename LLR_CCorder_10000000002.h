...
#include <map>
#define GETBKGO
int getNomBkgO_10000000002(int state, int pl, int ph, int cl, int ch)
{
...
#ifdef GETBKGO
#define GETBKGO2
int getNomBkgO_10000000002(ana_bins x){
	return getNomBkgO_10000000002(x.state, x.pl, x.ph, x.cl, x.ch);
};
#endif