...
//		for ( auto ab : {ana_bm_comb["3c"][0],ana_bm_comb["3c"][1],ana_bm_comb["3p"][0]}){
		for ( auto ab : {ana_bm_comb["3c"][0]}){
			if(ab.bintype !=kCent){
			auto res_nom = getRAAValue(true, ab, "CB3:EE:GC", -2, 1, 0, 100019111111, false, false, 2);
			auto res_fitsig = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 111019111111, false, false, 2);
			double bl = -2;
...
//			auto res_wider_sblow = getRAAValue(true, ab, "CB3:EE:GCnobdtcheck", -1.00000, 1, 0, 20000000000);
			auto res_wider_sblow = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 113019111111, false, false, 2);
			bl = -2;
//			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GC", bl, 1, 0, 20000000011); //original
			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 114019111111, false, false, 2);

			auto res_smpl2 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 200019111111, false, false, 2);
			auto res_smpl3 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 112019111111, false, false, 2);
//			ab.state =2;
			auto res_smpl4 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 110019111111, false, false, 2); //100219111111 Problem

			auto res_smpl5 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 210019111111, false, false, 2);
			auto res_smpl6 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 100019111111, false, false, 2);
			auto res_smpl7 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 111019111111, false, false, 2);
			auto res_smpl8 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 113019111111, false, false, 2);
			auto res_smpl9 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 114019111111, false, false, 2);
			auto res_smpl10 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 200019111111, false, false, 2);
...
//			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GCnobdtcheck", 0.4, 1, 0, 20000000000, false);
			...
			g1->AddPoint(0.2 + counter , res_nom.getVal());
			g2->AddPoint(0.35+ counter, res_fitsig.getVal());
			g3->AddPoint(0.5 + counter, res_wider_sblow.getVal());
			g4->AddPoint(0.65 + counter, res_smpl1.getVal());
			g5->AddPoint(0.8 + counter, res_smpl2.getVal());
			g6->AddPoint(1.05 + counter, res_smpl3.getVal());
			g7->AddPoint(1.2 + counter, res_smpl4.getVal());
			g8->AddPoint(1.35 + counter, res_smpl5.getVal());
			g9->AddPoint(1.6 + counter, res_smpl6.getVal());
			g10->AddPoint(1.85 + counter, res_smpl7.getVal());
			g11->AddPoint(2.0 + counter, res_smpl8.getVal());
			g12->AddPoint(2.15 + counter, res_smpl9.getVal());
			g13->AddPoint(2.3 + counter, res_smpl10.getVal());
	...
	TFile* fout = new TFile("corryield_2S.root", "recreate");
	fout->cd();
	g1->SetName("2S_g1");
	g2->SetName("2S_g2");
	g3->SetName("2S_g3");
