...
//		for ( auto ab : {ana_bm_comb["3c"][0],ana_bm_comb["3c"][1],ana_bm_comb["3p"][0]}){
		for ( auto ab : {ana_bm_comb["3c"][0]}){
			...
			auto res_fitsig = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 111019111111);
			double bl = -2;
...
//			auto res_wider_sblow = getRAAValue(true, ab, "CB3:EE:GCnobdtcheck", -1.00000, 1, 0, 20000000000);
			auto res_wider_sblow = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 113019111111);
			bl = -2;
//			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GC", bl, 1, 0, 20000000011); //original
			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 114019111111);

			auto res_smpl2 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 200019111111);
			auto res_smpl3 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 112019111111);
//			ab.state =2;
			auto res_smpl4 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 110019111111); //100219111111 Problem

			auto res_smpl5 = getRAAValue(true, ab, "CB3:EE:GC", 0.2620, 1, 0, 210019111111);
			auto res_smpl6 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 100019111111);
			auto res_smpl7 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 111019111111);
			auto res_smpl8 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 113019111111);
			auto res_smpl9 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 114019111111);
			auto res_smpl10 = getRAAValue(true, ab, "CB3:EE:GC", -0.9990, 1, 0, 200019111111);
...
//			auto res_smpl1 = getRAAValue(true, ab, "CB3:EE:GCnobdtcheck", 0.4, 1, 0, 20000000000, false);
	...
	leg->AddEntry(g6, "alternate train, nominal BDT, dataset1 blind", "pe");
	leg->AddEntry(g7, "alternate train, nominal BDT, dataset2 blind", "pe");
	leg->AddEntry(g8, "alternate train, nominal BDT, Full", "pe");
	...
	TFile* fout = new TFile("corryield_3S.root", "recreate");
	fout->cd();
	g1->SetName("3S_g1");
	g2->SetName("3S_g2");
	g3->SetName("3S_g3");
