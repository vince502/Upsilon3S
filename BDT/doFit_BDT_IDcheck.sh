...
export timestamp=$ts
	cd ..
root -l -b -q '_BDTFIT.C("./BDT/roodatasets/OniaRooDataset_BDT'$timestamp'_OniaSkim_TrigS13_BDT_IDcheck.root", 0, 30, -2.4, 2.4, "3p5", "S13", 0, 180, 0.01,-1., (Double_t[]) {0.05, 1.58, 3.68, 0.5, 7., 4., 1.1})' &  2>/dev/null
