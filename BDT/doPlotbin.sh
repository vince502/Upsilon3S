...
#root -l -b -q 'PlotYieldtoEffandSignifbin.C(1614848550, 2.4, 0., 30., 0, 180, false)'
#
...
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 4., 0, 180, false)'&
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 4., 9., 0, 180, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 9., 12., 0, 180, false)'&
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 12., 30., 0, 180, false)'
#


root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 6. , 0  , 180, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 6., 30., 0  , 180, false)'

root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 6. , 0  , 40 , false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 6., 30., 0  , 40 , false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 30., 0  , 40 , false)'

root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 6. , 40 , 100, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 6., 30., 40 , 100, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 30., 40 , 100, false)'

root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 6. , 100, 180, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 6., 30., 100, 180, false)'
root -l -b -q 'PlotYieldtoEffandSignifbin.C('$ts', '$ylim', 0., 30., 100, 180, false)'
