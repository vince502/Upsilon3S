...
///////////////
  ...
  if(strcmp(opt.c_str(),"NOMINAL")==0) _ts = (long) 10000000015;
...
//    loader->AddSpectator("QQVtxProb", "Vtx prob", "F");
    ...
    Double_t backgroundWeight = 1e-4; //1e-3;
    ...
    loader1->AddBackgroundTree (BkgTreeTrain1,	backgroundWeight*yieldBkg/BkgTreeTrain1->GetEntries(), "Train");
    loader1->AddBackgroundTree (BkgTreeTest1,	backgroundWeight*yieldBkg/BkgTreeTest1->GetEntries(), "Test");
    loader2->AddBackgroundTree (BkgTreeTrain2,	backgroundWeight*yieldBkg/BkgTreeTrain2->GetEntries(), "Train");
    loader2->AddBackgroundTree (BkgTreeTest2,	backgroundWeight*yieldBkg/BkgTreeTest2->GetEntries(), "Test");
