...
function TRAINER4 {
	...
	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{0,30}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{0,3}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{0,4}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{3,6}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{6,9}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{9,15}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{9,15}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{15,30}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{0,30}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{4,9}})"
#	root -l -b -q "BDTNominalProcess.cxx(10000000008,0, {{15,30}})"
##	root -l -b -q "BDTNominalProcess.cxx("$TS",0, {{0,30}})"
##	root -l -b -q "BDTNominalProcess.cxx("$TS",0, {{0,4}})"
##	root -l -b -q "BDTNominalProcess.cxx("$TS",0, {{4,9}})"
