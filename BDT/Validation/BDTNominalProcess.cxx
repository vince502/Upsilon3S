...
void BDTNominalProcess(long ts=1635139612, int mode =0)
{
	if(  mode ==0){
		BDTClassifierApplication_NOM(ts, 3, 9, 0, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, false, 3, 0, 30 );
		BDTClassifierApplication_NOM(ts, 2, 9, 0, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, false, 2, 0, 30 );
		BDTClassifierApplication_NOM(ts, 1, 9, 0, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, false, 1, 0, 30 );
	}
	if(mode ==0){
		BDTClassifierApplication_NOM(ts, 3, 3, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 3, 0, 30, "nan");
		BDTClassifierApplication_NOM(ts, 2, 2, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 2, 0, 30, "MC_2S");
		BDTClassifierApplication_NOM(ts, 1, 1, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 1, 0, 30, "MC_1S");
	}
	if(mode ==1){
		BDTClassifierApplication_NOM(ts, 3, 2, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 3, 0, 30, "MC_2S");
		BDTClassifierApplication_NOM(ts, 3, 1, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 3, 0, 30, "MC_1S");
	}
	if(mode ==1){
		BDTClassifierApplication_NOM(ts, 2, 3, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 2, 0, 30, "nan");
		BDTClassifierApplication_NOM(ts, 2, 1, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 2, 0, 30, "MC_1S");
	}
	if(mode ==1){
		BDTClassifierApplication_NOM(ts, 1, 2, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 1, 0, 30, "MC_2S");
		BDTClassifierApplication_NOM(ts, 1, 3, 1, true, 0, 30);
		makeRooDataset_fromBDT_NOM(ts, true, true, 1, 0, 30, "nan");
	}
	if(mode!=0 && mode !=1 ){
  BDTClassifierApplication_NOM(ts, 3, 9, 0, true, 0, 30);
  BDTClassifierApplication_NOM(ts, 3, 3, 1, true, 0, 30);
