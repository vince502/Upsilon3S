...
#	root -l -b -q "BDTNominalProcess.cxx(140019111111, 140019111111, 0, {{0,30}}, \"testBlind_Quat4.root\")"
	root -l -b -q "BDTNominalProcess.cxx(110019111111, 110019111111, 0, {{0,30}})"
...
TS=140019111111 #FROM 40
DATPREP=""\"SplitSeed=100:SplitMode=Random:NormMode=None:Correlations=False:!V\"""
OPT=""\"\!H:\!V:NTrees=350:MaxDepth=3:MinNodeSize=10%:BoostType=Grad:Shrinkage=0.1:UseBaggedBoost=True:SeparationType=GiniIndex:PruneMethod=CostComplexity:PruneStrength=1:PruningValFraction=0.3:UseRandomisedTrees=False:BaggedSampleFraction=0.4:nCuts=200:DoBoostMonitor:VarTransform=G+D\"""
TRAINERCheck
