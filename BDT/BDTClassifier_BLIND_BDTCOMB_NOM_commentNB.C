...
//Main Function
void BDTClassifier_BLIND_BDTCOMB_NOM_commentNB( long _inputts , string _bookOpt, string _datprep, bool nomonly = false){
  ofstream log;
  //log.open("BDT_description.log", std::ios_base::out|std::ios_base::app);
...
//  		if(!res)std::system(Form("rm ./.past_source/_BDT_Blind_Classifier__BDT%ld.old",(long) _real_time));
//
//		res = BDTClassifier_BLIND_Function(3,0,9, 15, 0,181, "NOMINAL", _inputts, _bookOpt, _datprep);
//  		if(!res)std::system(Form("rm ./.past_source/_BDT_Blind_Classifier__BDT%ld.old",(long) _real_time));
...
//  		if(!res)std::system(Form("rm ./.past_source/_BDT_Blind_Classifier__BDT%ld.old",(long) _real_time));
//
//		res = BDTClassifier_BLIND_Function(3,0,15,30, 0,181, "NOMINAL", _inputts, _bookOpt, _datprep);
//  		if(!res)std::system(Form("rm ./.past_source/_BDT_Blind_Classifier__BDT%ld.old",(long) _real_time));
	}
