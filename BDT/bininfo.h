...
std::map<std::string, std::vector<ana_bins> > ana_bm_comb ={
	{"2c", 	{
		{"i", kInt, "", 0, 30, 0, 30, 0, 181, 0, 90, 10, 2,3},
		{"c", kCent, "", 0, 30, 0, 30,  0, 10, 0, 5, 9, 2,3},
		{"c", kCent, "", 0, 30, 0, 30,  10, 20, 5, 10, 8, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 20, 40, 10, 20, 7, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 40, 60, 20, 30, 6, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 60, 80, 30, 40, 5, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 80, 100, 40, 50, 4, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 100, 120, 50, 60, 3, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 120, 140, 60, 70, 2, 2,3},
		{"c", kCent, "", 0, 30, 0, 30, 140, 181, 70, 90, 1, 2,3},
		}
	},
//	{"3c", 	{
//		{"i", kInt, "", 0, 30, 0, 30, 0, 181, 0, 90, 7, 3,3},
//		{"c", kCent, "", 0, 30, 0, 30,  0, 40, 0, 20, 6, 3,3},
//		{"c", kCent, "", 0, 30, 0, 30, 40, 60, 20, 30, 5, 3,3},
//		{"c", kCent, "", 0, 30, 0, 30, 60, 80, 30, 40, 4, 3,3},
//		{"c", kCent, "", 0, 30, 0, 30, 80, 100, 40, 50, 3, 3,3},
//		{"c", kCent, "", 0, 30, 0, 30, 100, 140, 50, 70, 2, 3,3},
...
//	},
	{"3c", 	{
		{"i", kInt, "", 0, 30, 0, 30, 0, 181, 0, 90, 5, 3,3},
		{"c", kCent, "", 0, 30, 0, 30,  0, 60, 0, 30, 4, 3,3},
		{"c", kCent, "", 0, 30, 0, 30, 60, 100, 30, 50, 3, 3,3},
		{"c", kCent, "", 0, 30, 0, 30, 100, 140, 50, 70, 2, 3,3},
		{"c", kCent, "", 0, 30, 0, 30, 140, 181, 70, 90, 1, 3,3},
		}
	},
	{"2p", 	{
		{"p", kPt, "", 0, 3, 0, 3,  0, 181, 0, 90, 1, 2,3},
		{"p", kPt, "", 3, 6, 3, 6,  0, 181, 0, 90, 2, 2,3},
		{"p", kPt, "", 6, 9, 6, 9,  0, 181, 0, 90, 3, 2,3},
		{"p", kPt, "", 9, 15, 9, 15,  0, 181, 0, 90, 4, 2,3},
		{"p", kPt, "", 15, 30, 15, 30,  0, 181, 0, 90, 5, 2,3},
		}
	},
	{"3p", 	{
		{"p", kPt, "", 0, 4, 0, 4,  0, 181, 0, 90, 1, 3,3},
